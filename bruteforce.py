...
if __name__ == '__main__':
    ...
    # pw = open("/Users/tobyluu/Downloads/CSC_mini_project_python 2/mini_project_python/Brute_Force/passwords.txt", "r")

    with open("/Users/tobyluu/Downloads/CSC_mini_project_python 2/mini_project_python/Brute_Force/passwords.txt") as pw:
        #read_data = pw.read()
        for line in pw:
            line = line.rstrip()
            #if line:
            ...
            if Found == True:
                print("I've found the password and it took " + str(Fails) + " tries.")
                sys.exit()
